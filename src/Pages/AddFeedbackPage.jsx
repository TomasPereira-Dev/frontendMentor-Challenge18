                ...
                <div className="relative flex flex-col gap-6 bg-white px-6 py-10 pb-6 rounded-lg">
                    ...
                    <form className="flex flex-col gap-4" id="form" onSubmit={handleSubmit(onSubmit)}>
                        <div>
                            ...
                            <input className={`w-full px-4 py-3 text-sm bg-background1 rounded-lg ${errors.feedbackTitle ? 'outline outline-1 outline-red-500' : 'outline-none'}`} {...register("feedbackTitle", {required: true, pattern: /\S/})} type="text" />
                        ...
                        <div>
                            <div className="mb-2" >
                                ...
                                <div className="relative px-4 py-3 w-full bg-background1 rounded-lg" defaultValue={"Feature"} {...register("category")} onClick={() => {setDropdownIsOpen(!dropdownIsOpen)}}>
                        ...
                        <div>
                            ...
                            <input className={`w-full px-4 py-3 text-sm bg-background1  rounded-lg ${errors.feedbackDetail ? 'outline outline-1 outline-red-500' : 'outline-none'}`} {...register("feedbackDetail", {required: true, pattern: /\S/})} type="text" />
